...
|  | A nice-looking customizable embed for YouTube videos | ```fab add_youtube_embed:$SLUG``` |
|  | A responsive embed region designed for Coral Project Ask forms | ```fab add_coral_ask:$SLUG``` |
